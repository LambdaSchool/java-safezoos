...
import com.stepasha.zoo.services.UserService;
...
public class UserController
{
    ...
    // http://localhost:2020/users/users/?page=1&size=1
    // http://localhost:2020/users/users/?sort=username,desc&sort=<field>,asc
...
//TODO 15 adding authority
    ...
    // http://localhost:2020/users/allusers
 ...
 //  // http://localhost:2020/users/user/7
    ...
    // http://localhost:2020/users/user/name/cinnamon
    ...
    // http://localhost:2020/users/user/name/like/da?sort=username
 //  @ApiImplicitParams({@ApiImplicitParam(name = "page",
 //                                        dataType = "integer",
 //                                        paramType = "query",
 //                                        value = "Results page you want to retrieve (1..N)"), @ApiImplicitParam(name = "size",
 ...
 //                                                                                                                                                                         value = "Sorting criteria in the format: property(,asc|desc). " + "Default sort order is ascending. " + "Multiple sort criteria are supported.")})
    ...
    // http://localhost:2020/users/user
    /*
            {
                "username": "Mojo",
...
*/
    ...
    // http://localhost:2020/users/user/14
    ...
    // http://localhost:2020/users/user/7/role/2
    ...
    // http://localhost:2020/users/user/15/role/2
    ...
    // http://localhost:2020/users/user/email/count
    ...
    //TODO 16 get users info



    // http://localhost:2020/users/getuserinfo
